...
const rNavbar = () => {
  ...
  else if(isAdm) links = [{h:'admin',l:'Dashboard',i:'◈'},{h:'admin-services',l:'Serviços',i:'✦'},{h:'admin-pros',l:'Profissionais',i:'✨'},{h:'admin-appointments',l:'Agendamentos',i:'📅'}];
...
const rAdmApts = () => {
  ...
  <div class="tbl-wrap">
    <table><thead><tr><th>Cliente</th><th>Serviço</th><th>Profissional</th><th>Data</th><th>Hora</th><th>Status</th><th>Ações</th></tr></thead>
